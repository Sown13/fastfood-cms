...
public class MaterialService extends CRUDBaseService<MaterialModel, Integer, MaterialRequest, MaterialResponse>{
    public MaterialService(IMaterialRepository repository, ModelMapper mapper, Class<MaterialModel> typeOfModel, Class<MaterialRequest> typeOfRequest, Class<MaterialResponse> typeOfResponse) {
        super(repository, mapper, typeOfModel, typeOfRequest, typeOfResponse);
    }
}
